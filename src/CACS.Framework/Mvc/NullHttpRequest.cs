...
namespace CACS.Framework.Mvc
{
    public class NullHttpRequest: HttpRequestBase
    {
        ...
        public NullHttpRequest(string relativeUrl, string method,
        ...
        public NullHttpRequest(string relativeUrl, string method, Uri url, Uri urlReferrer,
            NameValueCollection formParams, NameValueCollection queryStringParams,
            HttpCookieCollection cookies, NameValueCollection serverVariables)
        ...
        public NullHttpRequest(string relativeUrl, Uri url, Uri urlReferrer)
